            ...
            <div className='flex'>
                ...
                <div className='pl-52 m-5 pt-10'>
                    ...
                    <div className='flex space-x-72 pb-5'>
                        <div className='flex'>
                            <Link to="/addproducts" className='pt-2.5'><BsArrowLeft /></Link>
                    ...
                    <div className=' h-[90vh] w-[80vw] rounded-xl pl-10'>
                        
                        <div className="grid grid-cols-3 gap-x-3 mt-5 h-[70vh] justify-center gap-y-6">
                            {
                                ads.map((ad, index) => {
                                    console.log(`${index}: ${ad.title}`);
                                    return <div key={index} className="border-2 h-full w-[20vw] pl-8 shadow-lg shadow-slate-500">
                                        <Link to={`/dashboard/products/${ad.id}`} className='h-[35vh] w-[15vw]'>
